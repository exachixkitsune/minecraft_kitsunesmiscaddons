...
public class RestStop extends Structure<NoFeatureConfig> {

	// Only call super
	public RestStop(Codec<NoFeatureConfig> codec) {
		super(codec);
	}

	@Override
	public IStartFactory<NoFeatureConfig> getStartFactory() {
		return RestStop.Start::new;
	}
		...
		public void generatePieces(DynamicRegistries dynRegIn, ChunkGenerator chunkGenIn,
			...
			JigsawManager.addPieces(
                    ...
                    new VillageConfig(() -> dynRegIn.registryOrThrow(Registry.TEMPLATE_POOL_REGISTRY)
                    		.get(new ResourceLocation(KitsunesMiscAddons.MODID, "reststop_pool")),
                    		1),
